...
mapping *action = ({
    ...
    ([
        "action": "$N雙目直視$n，左手疾伸，與右手同時握住$w，劍隨意動，一招"HIC"「猶為離人照落花」"NOR"，$w大開大闔，向$n的$l直劈過去",
        "lvl": 90,
        "skill_name": "猶為離人照落花"
    ]),
    ([
    ...
    ([
        "action": "$N雙眉一揚，眼中殺氣大盛，一招"HIM"「化作春泥更護花」"NOR"，左腳腳尖點地，右腳迅速向前踏出一步，只見$N與手中$w合而為一，直奔$n而去",
        "lvl": 170,
        "skill_name": "化作春泥更護花"
    ]),
    ([
        "action": "$N抱元守一，運力於臂，一招"HIR"「人間處處有紅花」"NOR"，只見劍光閃閃，四下裡劍氣縱橫，$n幾乎要透不過氣來",
        "lvl": 180,
        "skill_name": "人間處處有紅花"
    ])
});
