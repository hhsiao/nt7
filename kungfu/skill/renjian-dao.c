...
int valid_learn(object me)
{
        ...
        if( query("max_neili", me)<2000 )
                return notify_fail("你的內力修為不夠，難以修煉人間道。\n");

        if ((int)me->query_skill("force") < 300)
                return notify_fail("你的內功火候太淺，難以修煉人間道。\n");

        if ((int)me->query_skill("sword", 1) < 300)
                return notify_fail("你的劍法根基不足，難以修煉人間道。\n");
    
        if ((int)me->query_skill("martial-cognize", 1) < 300)
                return notify_fail("你的武學修養不足，難以修煉人間道。\n");
                    
        if ((int)me->query_skill("buddhism", 1) < 200)
                return notify_fail("你的禪宗心法修為不足，難以修煉人間道。\n");
                                            
        if ((int)me->query_skill("sword", 1) < (int)me->query_skill("renjian-dao", 1))
                return notify_fail("你的基本劍法水平有限，無法領會更高深的人間道。\n");
...
int practice_skill(object me)
{
        if (me->query_skill("renjian-dao", 1) > 180)
                return notify_fail("人間道博大精深，無法簡單的通過練習進步。\n");
        return 1;                
}
