...
([
        "action" : "$N一招"HIM"「靈猿獻果赴蓬萊」"NOR"，身形如電，繞著$n飛快奔跑，手中$w一招快似一招，剎那間向$n連打出十六棍",
        "lvl"    : 100,
        "skill_name" : "靈猿獻果赴蓬萊"
]),
([
...
([
        "action" : "$N大喝一聲，一招"HIY"「天龍出水騰宇宙」"NOR"，$w脫手飛出，夾著勁風射向$n的前心，隨即搶到$n的身後，伸手又把$w抄在手中",
        "lvl"    : 130,
        "skill_name" : "天龍出水騰宇宙"
]),
([
...
int valid_learn(object me)
{
        ...
        if (fam["family_name"] != "少林派" )
                return notify_fail("韋陀杵只能從少林派學到。\n");
