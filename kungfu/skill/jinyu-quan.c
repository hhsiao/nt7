...
mapping *action = ({
    ...
    ([
        "action": "$N繞著$n一轉，滿場遊走，拳出如風，不絕擊向$n，正是一招"GRN"「金玉滿堂」"NOR"",
        "lvl": 80,
        "skill_name": "金玉滿堂"
    ]),
    ([
