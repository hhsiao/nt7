...
mapping *action = ({
    ([
        "action": "$N左掌一擺，護在胸前，接著右手食指畫出一個"HIB"「以」"NOR"字，輕輕點向$n$l",
        "lvl": 0,
        "skill_name": "以"
    ]),
    ([
        "action": "$N左手食指緩緩畫了個"HIM"「慈」"NOR"字，跟著手指微曲，以字為中心，對著$n一彈",
        "lvl": 20,
        "skill_name": "慈"
    ]),
    ([
    ...
    ([
        "action": "$N雙手小指向$n揮動，連點三點，接著雙指併攏，一招斜劃，拼成了一個"HIR"「心」"NOR"字",
        "lvl": 50,
        "skill_name": "心"
    ]),
    ([
        "action": "$N連連出招，幻出漫天指影，彷彿間竟然形成了一個"HIC"「摩」"NOR"字，照著$n激射而去，越來越快",
        "lvl": 60,
        "skill_name": "摩"
    ]),
    ([
        "action": "$N右手食指伸出，在空中寫出個"HIW"「訶」"NOR"字來，形如狂草，向著$n最後一提時竟飛射出一道青氣",
        "lvl": 70,
        "skill_name": "訶"
    ]),
    ([
        "action": "只見$N手指橫豎連劃，將指力在空中凝結不散，形成一個"CYN"「無」"NOR"字，對著$n當胸壓下",
        "lvl": 80,
        "skill_name": "無"
    ]),
    ([
