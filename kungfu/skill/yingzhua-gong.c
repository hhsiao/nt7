...
mapping *action = ({
    ...
    ([
        "action": "$N一式"HIB"「拔翅橫飛」"NOR"，全身向斜裡平飛，右腿一繃，雙爪搭向$n的肩頭",
        "lvl": 20,
        "skills_name": "拔翅橫飛"
    ]),
    ([
    ...
    ([
        "action": "$N騰空高飛三丈，一式"HIW"「鷹揚萬里」"NOR"，天空中頓時顯出一個巨靈爪影，緩緩罩向$n",
        "lvl": 60,
        "skills_name": "兇鷹襲兔"
    ])
});
