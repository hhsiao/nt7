...
mapping *action = ({
    ...
    ([
        "action": "$N運起丹田之氣猛喝一聲，一式"GRN"「觀勝峰」"NOR"，右掌挾帶著狂風，向前斜推，掌勢如劈山排雲搬壓向$n",
        "lvl": 70,
        "skill_name": "觀勝峰"
    ]),
    ([
    ...
    ([
        "action": "$N氣沉丹田，猛然怒喝一聲，向前一個弓步，雙掌合成"HIM"「朝天閘」"NOR"，帶著風雷之聲奮力擊向$n",
        "lvl": 110,
        "skill_name": "朝天閘"
    ]),
    ([
        "action": "$N右腿向前弓步，一招"CYN"「千丈淵」"NOR"，左手化拳為掌，勁氣十足，閃電般地由上向下劈$n",
        "lvl": 130,
        "skill_name": "千丈淵"
    ])
});
