...
",
    ...
    ([
        "action": "$N使一式"HIM"「雷震四方」"NOR"，四面八方出現無數掌影，一爪突出，抓向$n的胸口",
        "lvl": 40,
        "skill_name": "雷震四方"
    ]),
    ([
    ...
    ([
        "action": "$N嶽立霆峙，一式"HIY"「地老天荒」"NOR"，在一陣暴雷聲中，雙手同時拍中$n的七道死穴",
        "lvl": 60,
        "skill_name": "地老天荒"
    ])
});
...
int valid_combine(string combo) { return combo=="yingzhua-gong" || combo == "luohan-quan"; }
