...
// Create by 星雲鎖鏈(Fuyuan) at Thu Mar  5 07:38:01 2015
// 雞飛蛋打(dan)
#include <ansi.h>
#include <combat.h>
...
string name() { return HIW "雞飛蛋打" NOR; }
...
int perform(object me, object target)
{
        ...
        msg = HIW "$N從褲兜裡摸出兩枚雞蛋攥在手裡，衝著$n嘿嘿陰笑幾聲，然後用力一捏，$n渾身一震，打一哆嗦，被$N近身在下陰狠狠踢了一腳。" + "\n" + NOR;
        ...
        if (ap * 2 / 3 + random(ap) > dp)
        {
                ...
                msg += COMBAT_D->do_damage(me, target, attack, damage, 90, HIM "結果$n閃避不及，被$N的踹得眼仁泛白，嘴歪眼斜，半天動彈不得。" + "\n" NOR);
                addn("neili", -200, me);
                me->start_busy(1);
                /*
                if (! target->is_busy())
        ...
        {
                msg += NOR + CYN "可是$p識破了$P這一招，趁勢向後一躍避開。" + "\n" NOR;
                addn("neili", -100, me);
                me->start_busy(2);
        }
