...
mapping *action = ({
    ...
    ([
        "action": "$N一招"YEL"「開門見山」"NOR"，$w大開大闔，自上而下劃出一個大弧，筆直劈向$n",
        "lvl": 24,
        "skill_name": "開門見山"
    ]),
    ([
        "action": "$N手中$w一沉，一招"BLU"「臨溪觀魚」"NOR"，雙手持刃攔腰反切，砍向$n的胸口",
        "lvl": 33,
        "skill_name": "臨溪觀魚"
    ]),
    ([
        "action": "$N揮舞$w，使出一招"HIC"「張弓望的」"NOR"，上劈下撩，左擋右開，齊齊罩向$n",
        "lvl": 42,
        "skill_name": "張弓望的"
    ]),
    ([
        "action": "$N一招"HIC"「風送輕舟」"NOR"，左腳躍步落地，$w順勢往前，挾風聲劈向$n的$l",
        "lvl": 51,
        "skill_name": "風送輕舟"
    ]),
    ([
        "action": "$N盤身駐地，一招"HIB"「川流不息」"NOR"，揮出一片流光般的刀影，向$n的全身湧去",
        "lvl": 60,
        "skill_name": "川流不息"
    ])
});
...
int valid_learn(object me) {
    ...
    if ((int)me->query_skill("blade", 1) < (int)me->query_skill("cibei-dao", 1))
        return notify_fail("你的基本刀法水平有限，無法領會更高深的慈悲刀法。\n");
