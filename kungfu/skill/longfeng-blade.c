...
// Create by 劍人(Dlf) at Fri Mar  6 20:39:59 2015
// 龍鳳刀(longfeng-blade.c)
...
mapping *action = ({
// ZHAOSHI : 0
([      "action" : "$N縱身一躍，手握$w,頓時一招「臨」對準$n的$l刺出一劍",
	"attack" : 260,
	"damage" : 260,
	"force" : 260,
	"dodge" : 260,
...
// ZHAOSHI : 1
([      "action" : "$N縱身一躍，手握$w,頓時一招「兵」對準$n的$l一劍",
	"attack" : 260,
	"damage" : 260,
	"force" : 260,
	"dodge" : 260,
...
int valid_learn(object me)
{
        ...
        if( query("max_neili", me)<50 )
                return notify_fail("你的內力太弱，無法練" + "龍鳳刀" + "。\n");
