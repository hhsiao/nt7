...
// Create by 渡歐(Ssyunone) at Tue Jun 16 19:49:18 2015
// 淫指(yin-finger.c)
...
mapping *action = ({
// ZHAOSHI : 0
([      "action" : "$N兩臂緊伸，腿腳尖點地，一式「直搗子宮」，死死的頂住裸體的$n往半空中自旋而上旋轉",
	"attack" : 260,
	"damage" : 260,
	"force" : 260,
	"dodge" : 260,
...
int valid_learn(object me)
{
        if( query_temp("weapon", me) || query_temp("secondary_weapon", me) )
                return notify_fail("練"+"淫指"+"必須空手。\n");
        if( query("max_neili", me)<50 )
                return notify_fail("你的內力太弱，無法練"+"淫指"+"。\n");
        return 1;
}
...
{
	return
 "淫指是創自一代淫僧渡歐的絕世指法，招式勇往直前，大開大闔，以勇猛
性感霸道而著稱，當初被日本所有女優圍攻的時候，情勢萬分危機，渡歐
