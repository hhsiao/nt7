...
// Create by 劍人(Dlf) at Mon Mar  2 21:23:19 2015
// 龍之式(long)
#include <ansi.h>
#include <combat.h>
...
int perform(object me, object target)
{
        ...
        msg = HIW "$N手中武器寒氣逼人，劍身撕裂空氣，片片雪花飄落，劍未至氣先及，$n眉毛都蒙上了薄薄白霜！。" + "\n" + NOR;
        ...
        if (ap * 2 / 3 + random(ap) > dp)
        {
                ...
                msg += COMBAT_D->do_damage(me, target, attack, damage, 90, HIM "$n全然無法躲避，端端正正扎進在$n的胸口，鮮血登時飛濺而出" + "\n" NOR);
                addn("neili", -200, me);
                me->start_busy(1);
                /*
                if (! target->is_busy())
