...
int perform(object me, object target)
{
        ...
        if( userp(me) && !query("yuanshen", me) )
                return notify_fail("你還沒有悟道，暫時不能施展"+name()+"。\n");
        ...
        delta = ABILITY_D->check_ability(me, "ap_power-qzwds-chuan"); // 門派ab
        ...
        if (ap / 2 + random(ap) > dp)
        {
                ...
                delta = ABILITY_D->check_ability(me, "da_power-qzwds-chuan"); // 門派ab
