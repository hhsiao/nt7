...
mapping template_data = ([
        ...
        "grn gem2"    : ({ ({ GRN "一塊金光閃閃的精美寶石，華麗異常。\n" NOR,                10000,
                                ([ "SN" : random(9) + 1, "level" : 2, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/grngem2.c"  
                          }),
        "grn gem3"    : ({ ({ GRN "一塊金光閃閃的精美寶石，給人以不同尋常的感覺。\n" NOR,    12000,
                                ([ "SN" : random(9) + 1, "level" : 3, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/grngem3.c" 
                          }),
        "grn gem4"    : ({ ({ GRN "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  14000,
                                ([ "SN" : random(9) + 1, "level" : 4, "consistence" : 80 + random(21), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/grngem4.c" 
                          }),       
        "grn gem5"    : ({ ({ GRN "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  16000,
                                ([ "SN" : random(9) + 1, "level" : 5, "consistence" : 80 + random(21), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/grngem5.c" 
                          }),
        "grn gem6"    : ({ ({ GRN "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  18000,
                                ([ "SN" : random(9) + 1, "level" : 6, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/grngem6.c" 
                          }),
        "grn gem7"    : ({ ({ GRN "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  20000,                                 
                                ([ "SN" : random(9) + 1, "level" : 7, "consistence" : 80 + random(21), ]),
        ...
        "yel gem2"    : ({ ({ YEL "一塊金光閃閃的精美寶石，華麗異常。\n" NOR,                10000,
                                ([ "SN" : random(9) + 1, "level" : 2, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/yelgem2.c"
                          }),
        "yel gem3"    : ({ ({ YEL "一塊金光閃閃的精美寶石，給人以不同尋常的感覺。\n" NOR,    12000,
                                ([ "SN" : random(9) + 1, "level" : 3, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/yelgem3.c"
                          }),
        "yel gem4"    : ({ ({ YEL "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  14000,
                                ([ "SN" : random(9) + 1, "level" : 4, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/yelgem4.c"
                          }),
        "yel gem5"    : ({ ({ YEL "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  16000,
                                ([ "SN" : random(9) + 1, "level" : 5, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/yelgem5.c"
                          }),
        "yel gem6"    : ({ ({ YEL "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  18000,
                                ([ "SN" : random(9) + 1, "level" : 6, "consistence" : 80 + random(21), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/yelgem6.c"
                          }),
        "yel gem7"    : ({ ({ YEL "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  20000,
                                ([ "SN" : random(9) + 1, "level" : 7, "consistence" : 80 + random(21), ]),
        ...
        "blu gem2"    : ({ ({ BLU "一塊金光閃閃的精美寶石，華麗異常。\n" NOR,                10000,
                                ([ "SN" : random(9) + 1, "level" : 2, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/blugem2.c"
                          }),
        "blu gem3"    : ({ ({ BLU "一塊金光閃閃的精美寶石，給人以不同尋常的感覺。\n" NOR,    12000,
                                ([ "SN" : random(9) + 1, "level" : 3, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/blugem3.c"
                          }),
        "blu gem4"    : ({ ({ BLU "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  14000,
                                ([ "SN" : random(9) + 1, "level" : 4, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/blugem4.c"
                          }),
        "blu gem5"    : ({ ({ BLU "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  16000,
                                ([ "SN" : random(9) + 1, "level" : 5, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/blugem5.c"
                          }),
        "blu gem6"    : ({ ({ BLU "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  18000,
                                ([ "SN" : random(9) + 1, "level" : 6, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/blugem6.c"
                          }),
        "blu gem7"    : ({ ({ BLU "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  20000,
                                ([ "SN" : random(9) + 1, "level" : 7, "consistence" : 80 + random(21), ]),
        ...
        "mag gem2"    : ({ ({ MAG "一塊金光閃閃的精美寶石，華麗異常。\n" NOR,                10000,
                                ([ "SN" : random(9) + 1, "level" : 2, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/maggem2.c"
                          }),
        "mag gem3"    : ({ ({ MAG "一塊金光閃閃的精美寶石，給人以不同尋常的感覺。\n" NOR,    12000,
                                ([ "SN" : random(9) + 1, "level" : 3, "consistence" : 70 + random(31), ]), 
                              }), ([ ]), BASIC_OB_DIR + "gem/maggem3.c"
                          }),
        "mag gem4"    : ({ ({ MAG "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  14000,
                                ([ "SN" : random(9) + 1, "level" : 4, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/maggem4.c"
                          }),
        "mag gem5"    : ({ ({ MAG "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  16000,
                                ([ "SN" : random(9) + 1, "level" : 5, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/maggem5.c"
                          }),
        "mag gem6"    : ({ ({ MAG "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  18000,
                                ([ "SN" : random(9) + 1, "level" : 6, "consistence" : 80 + random(21), ]),
                              }), ([ ]), BASIC_OB_DIR + "gem/maggem6.c"
                          }),
        "mag gem7"    : ({ ({ MAG "一塊閃爍這奇異光芒的寶石，讓人感到一陣陣的心悸。\n" NOR,  20000,
                                ([ "SN" : random(9) + 1, "level" : 7, "consistence" : 80 + random(21), ]),
