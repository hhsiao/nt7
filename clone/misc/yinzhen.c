...
int do_heal(string arg) {
    ...
    {
        message_vision(HIY "$N" HIY "正想給$n" HIY "療傷，可$n" HIY "望著$N" HIY "那不停顫抖的雙手，臉上露出害怕的神色。\n" NOR + CYN "$n" CYN "皺了皺眉頭，對$N" CYN "說道：你那點手藝還是算了吧。\n"NOR, me, ob);
        return 1;
    }
    ...
    {
        msg += HIW"$N"HIW"的銀針準確無誤地刺入穴道，隨著銀針的緩緩轉動，"+s+HIW"長長地出了一口氣，臉色好看多了。"NOR;
        damage = -1;
