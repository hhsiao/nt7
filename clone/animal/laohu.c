...
void create() {
    ...
    set("race", "走獸");
    set("age", 25);
    set("long", "這是一頭吊睛白額，氣勢洶洶的大虎，正惡狠狠地盯著你，好象隨時隨地都會撲上來擇人而噬！\n");
    set("msg_fail", "$n衝$N呲牙吼了一聲");
    set("msg_succ", "$n一面口中向$N荷荷發威，一面向後退了半步，似乎有些怯了");
    set("msg_trained", "$n低吼著在$N的面前伏了下來");
    set("auto_follow", 1);
    ...
    set("chat_msg", ({
        ...
        "老虎用前爪拍擊著地面，口中荷荷發威，好象隨時都要撲上來！\n",
        "老虎微微側著腦袋，雙目炯炯，緊緊地注視著你的一舉一動。\n",
        "老虎突然立了起來，繞著你走了半圈，似乎在觀察著什麼。\n"
    }) );
