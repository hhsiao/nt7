...
int do_launch(string arg)
{
        ...
        message_vision(HIM "$N掏出一個" + name() + HIM "，喝道："
                       "“飛毛腿準備發射！”說罷一按開關！\n"
                       "就聽“轟”的一聲，" + name() + HIM "拍拍屁股不見了！\n" NOR, me);

        message_vision(HIC "突然天空傳來一陣呼嘯的聲音...\n" +
                       "“轟”的一聲，$N" HIC "被炸得飛起數米，跌倒在地，"
                       "一句話都說不出來...\n" NOR, ob);
        ...
        else
        {
                ...
                ob->ban_say_until(60, "你現在被炸得頭暈眼花，說不出話");
