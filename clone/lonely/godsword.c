...
string look_sword()
{
        ...
        "之久，運輸物資的道路被切斷，戰士和人們由於長期得不到補給，大\n"
        "都士氣低落，而斯洛塔神廟的牧師在戰役中卻擔任了救援和醫療的工\n"
        "作，同時牧師們也在不停地向諸神祈禱，以求保佑平安。盡管人們虔\n"
        "誠的信奉著諸神，等待上天給與幫助，但愛爾吉德仍於1042 DR 被半\n"
        "獸人攻佔，同時斯洛塔神廟成了一片廢墟，這把劍也不知所蹤。\n\n"
        "黑傑克·勞倫斯是一位墮落的聖武士，在撒丁亞城素以冷酷和勇猛著\n"
        "稱，人們稱他是「雙刃手」，卻不知他的很大一部分能力是來自於他\n"
        "的配劍。一次在撒丁亞城的酒吧中，一位喝醉的矮人盜賊不滿他的稱\n"
        "號，向他發出了挑戰。雖然黑傑克·勞倫斯英勇善戰，也手刃了這位\n"
        "狂妄的矮人盜賊，但他仍然敵不過前來幫忙的大群紅武士集團的僱傭\n"
        "兵，被分成了七塊。而這把劍也被傭兵頭領當作戰利品取走。\n\n" NOR
        "數據資料：\n"
