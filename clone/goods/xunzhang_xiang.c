...
void create() {
    ...
    //這個一定要設置：
    set("BAOXIANG_LIST", ([
        "/clone/medal/practice-emblem":600,     //物品文件名:概率
        "/clone/medal/derive-emblem":150,   //物品文件名:概率
        "/clone/medal/research-emblem":150,     //物品文件名:概率
        "/clone/medal/research-emblem2":100,    //物品文件名:概率
