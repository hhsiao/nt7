...
#define ENTRY_ROOM      "/d/city/biwu_dating"
#define FIGHT_ROOM      "/d/city/lunjian1"
...
protected int finish_competition()
{
        ...
        set_temp("competed", time(), challenger);
        ...
        */
        ...
        to_file=GAOSHOU_DIR+"npc/"+query("id", challenger)+".o";
