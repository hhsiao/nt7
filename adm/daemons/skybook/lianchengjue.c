...
string prompt() { return HIR "【連城訣】" NOR; } 
...
void go_on_process(object me, int next)
{
        ...
        case 5:
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/當前章節", "第1章", me);
                set("skybook14/連城訣/任務編號", 5, me);
                me->set_skill("tangshi-jian", 1);
                set("skybook14/連城訣/當前任務", "將唐詩劍法提升到500級（任務完成後輸入skybook start 連城訣）", me);
                break;

        case 10:
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/當前章節", "第1章", me);
                set("skybook14/連城訣/任務編號", 10, me);
                set("skybook14/連城訣/當前任務", "與師妹戚芳切磋武藝（fight qi fang）。", me);
                break;

        case 15:
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/任務編號", 15, me);
                set("skybook14/連城訣/當前任務", "蒐集白狐皮200張。", me);
                set("skybook14/連城訣/當前章節", "第1章", me);
                break;

        case 20:
                set("skybook14/連城訣/任務狀態", 1, me);
                set("skybook14/連城訣/任務編號", 20, me);
                set("skybook14/連城訣/當前任務", "準備好後就準備前往荊州萬府吧（skybook start 連城訣）", me);
                set("skybook14/連城訣/當前章節", "第1章", me);
                break;
        
        case 25:
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/任務編號", 25, me);
                set("skybook14/連城訣/當前任務", "擊敗大盜呂通", me);
                set("skybook14/連城訣/當前章節", "第1章", me);
                break;  
        ...
        case 30:
                move_to_room(me, 4);
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/任務編號", 30, me);
                set("skybook14/連城訣/當前任務", "輸入start skybook 連城訣 繼續劇情", me);
                break;          

        case 35:
                move_to_room(me, 5);
                set("skybook14/連城訣/當前章節", "第2章", me);
                set("skybook14/連城訣/任務狀態", 0, me);
                set("skybook14/連城訣/當前任務", "輸入start skybook 連城訣 繼續劇情", me);
                set("skybook14/連城訣/任務編號", 35, me);
                break;          
        default:
                break;
        }
...
int startbook(object me, string sBook)
{
        ...
        ob = this_object();
        sZhangjie = query("skybook14/" + sBook + "/當前章節", me);
        nQuest = query("skybook14/" + sBook + "/任務編號", me);
        mQuest = query("skybook14/" + sBook + "/當前任務", me);
        ...
        case 10: // 切磋打過戚芳後
                if( query("skybook14/連城訣/任務狀態", me) != 1 )
                {       
                        move_to_room(me, 1); // 任務未達成，重新傳送房間
        ...
        case 25: // 擊敗大盜呂通
                ...
                if( query("skybook14/連城訣/任務狀態", me) != 1 )
                {
                        move_to_room(me, 2); // 任務未達成，重新傳送房間
