...
#define FIRST           "/clone/medal/jingying_xunzhang1"
#define SECOND          "/clone/medal/jingying_xunzhang2"
#define THIRD           "/clone/medal/jingying_xunzhang3"
                ...
                if (query("loop"))
                {
                        ...
                        if (stringp(query("drum_knocked")))
                        {
                                ...
                                if (no1)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no1), sprintf("精英組 %s(%s)，年齡 %d、等級 %d，榮獲名次 1.\n",
                                ...
                                if (no2)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no2), sprintf("精英組 %s(%s)，年齡 %d、等級 %d，榮獲名次 2.\n",
                                ...
                                if (no3)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no3), sprintf("精英組 %s(%s)，年齡 %d、等級 %d，榮獲名次 3.\n",
        ...
        if (query("drum_knocked"))
        {
                ...
                foreach (object user in players)
                {
                        ...
                        if (user && ! wizardp(user) && (environment() == environment(user)))
                        {
                                ...
                                new("/clone/tessera/rune07")->move(user);
                                new("/clone/tessera/rune08")->move(user);
                                new("/clone/tessera/rune09")->move(user);
