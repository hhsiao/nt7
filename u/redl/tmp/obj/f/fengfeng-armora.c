// ITEM Made by player(風風:fengfeng) /data/item/f/fengfeng-armora.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Sep 22 18:16:48 2014
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m[42m玄甲鎧[2;37;0m", ({ "armora" }));
	set_weight(1500);
	set("item_make", 1);
	set("unit", "張");
