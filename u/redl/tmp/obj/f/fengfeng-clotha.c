// ITEM Made by player(風風:fengfeng) /data/item/f/fengfeng-clotha.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Sep 22 18:22:32 2014
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m[43m金縷衣[2;37;0m", ({ "clotha" }));
	set_weight(2000);
	set("item_make", 1);
	set("unit", "件");
