// ITEM Made by player(風風:fengfeng) /data/item/f/fengfeng-waista.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Sep 22 18:26:10 2014
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m[42m春水衿[2;37;0m", ({ "waista" }));
	set_weight(800);
	set("item_make", 1);
	set("unit", "條");
