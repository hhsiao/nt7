// ITEM Made by player(風風:fengfeng) /data/item/f/fengfeng-fingera.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Sep 22 18:36:19 2014
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m[44m朝露指[2;37;0m", ({ "fingera" }));
	set_weight(350);
	set("item_make", 1);
	set("unit", "套");
