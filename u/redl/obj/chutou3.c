        ...
        case 6:
                ...
                if (rnd<6){//魯智深出現
                        ...
                        for(i = random(5) + 3; i > 0; i--) {
                                ...
                                {
                                        case 0:
                                                new("/clone/fam/pill/sheli1")->move(me);
                                                break;
                                        case 1:
                                                new("/clone/fam/pill/puti1")->move(me);
                                                break;
                                        case 2:
                                                new("/clone/fam/pill/linghui1")->move(me);
                                                break;
                                        case 3:
                                                new("/clone/fam/pill/neili1")->move(me);
                                                break;
                                        default:
                                                new("/clone/fam/pill/full1")->move(me);
                                                break;
                                }
                        }
                        exp /= 3;
...
void create()
{
        set_name(MAG "紫煙鋤" NOR, ({ "ziyan chu", "chu tou", "chu" }));
        /*if (clonep())
