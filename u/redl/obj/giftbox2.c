...
#define EXPG 60000000

void create()
{
        set_name(NOR HIR"元旦"HIY"禮盒"NOR,({"box"}));
...
int do_open(string arg)
{
        ...
        if (lv >= 160) {
                GIFT_D->work_bonus(me, ([ "prompt":"被福地霞光沖刷洗滌之後", "exp" : EXPG / 9, "pot" : EXPG / 36 ]));
                ...
                GIFT_D->work_bonus(me, ([ "prompt":"被福地霞光沖刷洗滌之後", "exp" : EXPG / 3, "pot" : EXPG / 12 ]));
                ...
                GIFT_D->work_bonus(me, ([ "prompt":"被福地霞光沖刷洗滌之後", "exp" : EXPG, "pot" : EXPG / 4 ]));
                ob = new("/clone/medicine/yuqingwan");
                ob->set_amount(12);
                give_ob(me, ob);
