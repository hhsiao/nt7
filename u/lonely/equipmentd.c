...
mapping all_props = ([
        ...
        "avoid_poison"  : "忽視中毒",   // armor/rings \itemd.c/condition.c
        ...
        "ap_power"      : "絕招攻擊力",         // weapon/rings  \skillsd.c
        "dp_power"      : "絕招防禦力",         // armor         \skillsd.c
        "da_power"      : "絕招傷害力",         // weapon/rings  \skillsd.c
        ...
        "avoid_defense" : "忽視目標特防",       // rune \combatd.c
...
*/
                                        ...
                                        {
                                                CHANNEL_D->channel_broadcast("news",
                                                        HIY "數顆流星疾射而過，遠古蠻荒" + (random(2) ? "氣息" : "味道") + "四散飄逸...\n" + HIC + (random(2) ? "哐啷" : "噹地") + "~" + (random(2) ? "~" : "") + "~一聲，" +  ob->name() + NOR + HIC + "從天而降！\n"NOR);
                                        ...
                                        {
                                                CHANNEL_D->channel_broadcast("news",
                                                        HIK "黑白兩色照耀天地，太古洪荒" + (random(2) ? "氣息" : "味道") + "讓人窒息...\n" + HIC + (random(2) ? "哐啷" : "噹地") + "~" + (random(2) ? "~" : "") + "~一聲，" +  ob->name() + NOR + HIC + "從天而降！\n"NOR);
