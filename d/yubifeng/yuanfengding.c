...
void create()
{
        set("short", "圓峰頂");
        set("long", @LONG
峰頂積滿了千百年來從未消融的堅冰，歷年新雪，層層疊疊。遠望
四周，群峰在上，峰谷間寒風貫穿，嘶聲凌厲。峰頂正中，有一個微陷
的小窩。
LONG );
        set("exits", ([
...
int do_stamp(string arg)
{
        ...
        if( n>100 && query("qi", me)>1000 )
        {
                message_vision("$N深吸了一口氣，看準了方位，一步步走將過去。\n...\n待走到圓峰之頂的窩兒正中，用力踩踏，果然腳下鬆動，身子下落。\n...\n$N早有防備，雙足著地，立即幌亮火摺，撥開冰雪，見前面是條長長的通道。\n",me);
                me->move(__DIR__"tongdao1");
        }
        else
        {
                message_vision("$N在峰頂踩來踏去，踢得冰屑雪花濺飛，結果全無動靜。\n", me);
