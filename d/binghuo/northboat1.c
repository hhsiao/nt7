...
int do_gua ( string arg )
{
        ...
        {
                tell_object(this_player() , "帆布在哪？你四下一望，沒見著！\n");
                return 1 ;
        }
...
呼喝聲中又夾著疾風呼嘯，波浪轟擊之聲，似乎千百個巨浪同
時襲到。你只感全身一涼，口中鼻中全是鹽水，當即掙扎著站
...
聲大響，只打得船木橫飛。\n" NOR) ;
        if( query("neili", ob)<300 )
        {
                tell_object(ob , HIR
"\n驀地裡一個巨浪飛到，將你衝出船舷之外。這個浪頭來得極其
...
雲滿天，大雨如注，四下裡波濤山立，這當兒根本分不出東南
西北。船身一時如上高山，片刻間似瀉深谷，桅檣盡折，船隻
也已無法駕駛。\n" NOR);
        ob->move (__DIR__"northboat4") ;
        tell_object(ob , BLU
"海流一直向北，帶著船隻日夜不停的北駛。夜晚北極星總是在
