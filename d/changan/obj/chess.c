...
//兵
        ...
        if( sROW == tROW )
                if( cc1 == 2 )
                        msg = sprintf("『%s』%s平%s", TABLE[table[tROW]][tCOL][1], chinese_number(sCOL/2+1), chinese_number(tCOL/2+1) );
                else
                        msg = sprintf("『%s』%s平%s", TABLE[table[tROW]][tCOL][1], chinese_number(10-(sCOL/2+1)), chinese_number(10-(tCOL/2+1)) );
