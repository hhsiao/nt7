...
void greeting(object ob) {
    ...
    case 1:
        ...
        break;
    case 2:
        say("店小二熱情地打招呼，說道：這位" + RANK_D->query_respect(ob) + "，嚐嚐我們嘉興的臭鴨蛋吧，很好吃的。\n");
        break;
    case 3:
        say("店小二熱情地打招呼，說道：這位" + RANK_D->query_respect(ob) + "，嚐嚐我們嘉興的特產南湖粽子吧。\n");
        break;
    }
}
...
void kicking(object ob) {
    ...
    message("vision", "只聽“乒”地一聲，"+query("name", ob) + "被人從煙雨樓裡一腳踢了出來，狼狽萬狀的逃開了。\n", environment(ob), ob);
}
