...
可能是因為它長時間被龍象內力籠罩，所以也似乎有了儲存內力的功效。你可以試試注入內力(longxiang)。\n"NOR);
                ...
                set("unique", 1);
                set("value", 100);
                set("wear_msg", HIW"只見$N雙手一抖，便把一件隱隱透著紫色光彩的袈裟穿在了身上。\n" NOR);
...
int do_add(string arg)
{
        ...
        set("long", MAG"這是一件喇嘛穿的袈裟，上面繡著些梵文，看似普通但卻是大輪寺開寺始祖終身所穿的袈裟。
