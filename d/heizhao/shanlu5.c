...
後躍，硬生生把兩隻腳拔了出來，一股汙泥的臭味極是刺鼻。向前
望去，眼前一團茫茫白霧裹著兩間茅屋 (house)，燈光便從茅屋中
射出。
LONG );
        set("outdoors", "heizhao");
        set("no_clean_up", 0);
        set("item_desc", ([
                "house" : "茅屋一方一圓，建在汙泥湖沼之中，四周無處落腳。看來
你只好跳進去了。\n",
        ]));
        set("exits", ([
                "southeast"  : __DIR__"maze2",
        ]));
        set("coor/x", -5100);
        set("coor/y", -1500);
        set("coor/z", -5);
...
int do_jump(string arg)
{
        ...
        {
message_vision(HIR"結果只聽一聲悶哼，$N還沒躍到牆頭就掉在泥沼裡了...\n"NOR,me);
message_vision(HIB"屋裡伸出一隻女人的手，提起$N的衣領，一拋就拋出林外去了。\n"NOR,me);
        ...
        if (arg == "right")
        {
message_vision(HIC"只聽一聲轟響，真是帥呆了，$N正掉在水塘裡！\n"NOR,me);
message_vision(HIB"屋裡伸出一隻女人的手，提起$N的衣領，一拋就拋出林外去了。\n"NOR,me);
