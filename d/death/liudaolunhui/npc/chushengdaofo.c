...
void create() {
    set_name(HIC "畜生道佛" NOR, ({ "chushengdao fo", "chushengdao", "fo" }) );
    set("gender", "男性");
    set("title", HIW "畜生道守護者" NOR);
    set("age", 200);
    set("long", HIC "守衛六道中的畜生道的佛。\n\n" NOR);
...
mixed hit_ob(object me, object ob, int damage_bouns) {
    ...
    damage-=query_temp("apply/reduce_lighting", ob);
    if (damage < 0) damage = 0;
    ob->receive_wound("qi", damage, me);
    set("neili", query("max_neili", me), me);
    return HIB "$N" HIB "一聲暴喝，剎那間霹靂電閃，紫雷"
    HIB "轟鳴，千萬道閃電至九天而降，籠罩大地。\n" NOR;
}
...
void ob_die(object me) {
    ...
    set_temp("die_reason", "被畜生道佛給活活殺死了", me);
    me->die();
}
...
void lost() {
    ...
    set("reborn_lunhui", "chushengdao", ob);
    set("special_skill/monster", 1, ob);
