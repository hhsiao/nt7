...
void create()
{
        set_name(HIC "餓鬼道佛" NOR, ({ "eguidao fo", "eguidao", "fo" }) );
        set("gender", "男性");
        set("title", HIW "餓鬼道守護者" NOR);
        set("age", 200);
        set("long", HIC "守衛六道中的餓鬼道的佛。\n\n" NOR);
...
void ob_die(object me)
{
        ...
        set_temp("die_reason", "被餓鬼道佛給活活殺死了", me);
        me->die();       
}
...
void lost()
{
        ...
        set("reborn_lunhui", "eguidao", ob);
        set("special_skill/nopoison", 1, ob);
