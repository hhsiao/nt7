...
void create() {
    set_name(HIC "修羅道佛" NOR, ({ "xiuluodao fo", "xiuluodao", "fo" }) );
    set("gender", "男性");
    set("title", HIW "修羅道守護者" NOR);
    set("age", 200);
    set("long", HIC "守衛六道中的修羅道的佛。\n\n" NOR);
...
mixed hit_ob(object me, object ob, int damage_bouns) {
    ...
    return HIB "$N" HIB "一聲暴喝，地面揚起一片火海，似"
    HIB "乎整個大地都要被烤焦了一般。\n" NOR;
}
...
void ob_die(object me) {
    ...
    set_temp("die_reason", "被修羅道佛給活活殺死了", me);
    me->die();
}
...
void lost() {
    ...
    set("reborn_lunhui", "xiuluodao", ob);
    set("special_skill/demon", 1, ob);
