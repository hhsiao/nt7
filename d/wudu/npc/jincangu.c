...
void levelup()
{
        ...
        set("max_qi", 9999 + query("owneradd") * lv);
        set("max_jing", 9999 + query("owneradd") / 2 * lv);
        set("str", 4000 + lv * 2000);
        set("con", 50 + lv);
        set("dex", 6000 + lv * 3000);
    set_temp("apply/attack", 500 + lv * 250);
    set_temp("apply/damage", 500 + lv * 250);
    set_temp("apply/armor", 500 + lv * 250);
    ...
    set("worm_poison", ([
        ...
        set_temp("apply/reduce_damage", 49 + lv / 2);
