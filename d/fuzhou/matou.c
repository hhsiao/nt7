...
// Last Modified by Lonely on Sep. 20 2002
...
void create() {
    set("short", "中洲碼頭");
    set("long", @LONG
這裡是福州中洲碼頭，眼前閩江水(river) 波濤翻滾，船隻穿梭來
往不斷。這裡有通往上游延平府的客船。
LONG );
    set("exits", ([
...
十幾個水手握著長長的槳，船尾一名六十多歲的老艄公把著櫓。江面的
水非常清澈，兩邊的山峰險峻，蒼翠的森林中時而傳來野獸的嘶嚎。
LONG );
