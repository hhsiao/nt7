...
void create() {
    ...
    varargs void generate_bandit(string zone, mapping coor, int z)
    {
        ...
        int i, j, length_x, length_y, step, x, y;
    ...
    int do_driving(string arg) {
        object me;
        int distance, max_speed, max_driving;
        object obj;
    ...
    string display_map(string arg) {
        object *inv, obj, me;
        int n, length, ks;
        int max_x, max_y, min_x, min_y, length_x, length_y, i, j, k, h, type, x1, y1, x2, y2, z1, z2;
        mapping *wall;
        mixed *xy;
        string name;
        string msg = "\n";
