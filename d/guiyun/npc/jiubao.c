...
void create()
{
        ...
        set("inquiry", ([
                ...
                "rumors" : "歸雲莊的弟子們總來這裡，有時候談到桃花島，都流露出嚮往的神情。",
...
int accept_object(object who, object ob)
{
        ...
        if( query("money_id", ob)){
                ...
                tell_object(who, "酒保道：“我帶你去掌櫃那裡付帳。”\n");
                tell_object(who, "你跟著酒保來到櫃檯前，把錢交給掌櫃。\n");
...
void kill_ob(object ob)
{
        ...
        remove_killer(ob);
        message_vision("酒保對$N冷笑道：“別裝腔作勢啦，象你這種扮兇巴巴妄圖吃飯不付錢的傢伙我見多了，省省吧。”\n", ob);
