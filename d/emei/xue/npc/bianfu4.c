...
void create()
{
        set_name(HIR "吸血" NOR WHT "銀蝠" NOR, ({ "xixue bianfu", "xixue", "bianfu" }));

           set("shen", -1000);
        set("age", 10 + LV);
        set("str", 350 + LV * 35);
        set("dex", 1000 + LV * 100);
        set("max_qi", 100000 * LV * LV);
        set("max_ging", 100000 * LV * LV);
        set("eff_jing", 50000 * LV * LV);
        set("max_jing", 50000 * LV * LV);
        ...
        set("combat_exp", 5000000 * LV * LV * 2);
        ...
        set_skill("count", 500 + random(500) + LV * LV * 50);
        set_skill("dodge", 200 + random(200) + LV * LV * 25);
        set_skill("qingfu-shenfa", 200 + random(200) + LV * LV * 25);
        map_skill("dodge", "qingfu-shenfa"); 
        set_skill("force", 200 + random(200) + LV * LV * 25);
        set_skill("xuanming-shengong", 200 + random(200) + LV * LV * 25);
        map_skill("force", "xuanming-shengong"); 
        set_skill("claw", 200 + random(200) + LV * LV * 25);
        set_skill("ningxue-shenzhao", 200 + random(200) + LV * LV * 25);
        map_skill("claw", "ningxue-shenzhao"); 
        set_skill("parry", 200 + random(200) + LV * LV * 25);
...
/*        set("chat_chance_combat", 120); 
        ...
        set("gift/exp", 320 + (LV * 160));
        set("gift/pot", 80 + (LV * 40));
        set("gift/mar", 20 + (LV * 10));
...
void init()
{
        ...
        {
                tell_object(this_player(), query("name", this_object()) + NOR CYN "桀桀怪笑，化為一道銀色勁裝的青年向你撲來...\n" NOR);
