...
void create()
{
        set_name(HIR "吸血" NOR YEL "金蝠" NOR, ({ "xixue bianfu", "xixue", "bianfu" }));

           set("shen", -1000);
        set("age", 10 + LV);
        set("str", 350 + LV * 35);
        set("dex", 1000 + LV * 100);
        set("max_qi", 100000 * LV * LV * LV * 3 / 4 * 15);
        set("max_ging", 100000 * LV * LV * LV * 3 / 4 * 15);
        set("eff_jing", 50000 * LV * LV * LV * 3 / 4 * 15);
        set("max_jing", 50000 * LV * LV * LV * 3 / 4 * 15);
        ...
        set_skill("count", 500 + random(500) + LV * LV * 360);
                set_skill("martial-cognize", 500 + random(500) + LV * LV * 270);
        set_skill("dodge", 200 + random(200) + LV * LV * 270);
        set_skill("qingfu-shenfa", 200 + random(200) + LV * LV * 270);
        map_skill("dodge", "qingfu-shenfa"); 
        set_skill("force", 200 + random(200) + LV * LV * 270);
        set_skill("xuanming-shengong", 200 + random(200) + LV * LV * 270);
        map_skill("force", "xuanming-shengong"); 
        set_skill("strike", 200 + random(200) + LV * LV * 270);
        set_skill("xuanming-zhang", 200 + random(200) + LV * LV * 270);
        map_skill("strike", "xuanming-zhang"); 
        set_skill("parry", 200 + random(200) + LV * LV * 270);
...
{
        // 隨機攻擊玩家
        if (userp(this_player()) && !query("env/invisible", this_player()) && !random(3))
        {
                tell_object(this_player(), query("name", this_object()) + NOR CYN "桀桀怪笑，化為一道金色勁裝的青年向你撲來...\n" NOR);
