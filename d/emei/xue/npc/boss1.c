...
#define BONUS_EXP 8000

int do_copyskill();


void create() {
    set_name(HIR "血蝠王" NOR, ({ "xixue bianfu", "xixue", "bianfu" }));
    set("str", 1);
    set("con", 1);
    set("dex", 1);
    set("int", 1);
...
varargs void die()
{
    ...
    if(random(LEV / 50) &&  //x% can call_die
