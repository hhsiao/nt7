...
string * shot_str = ({
    ...
    "$N將釘盒上的機鈕一掀，只聽得‘嗤嗤’破空聲不斷，數十細若髮絲的梨花釘一掠而過，直射$n！\n",
    "$N抬起手來按動了機鈕，一支暗器從$N的袖筒裡向$n射去！\n"
});
