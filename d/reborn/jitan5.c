...
void create() {
    set("short", "嵩山祭壇");
    set("long", @LONG
五嶽之中嶽嵩山祭壇處，祭壇上有青銅鼎香爐一座，終年香火不滅，
若身有閻王契，點上召神香，則可召喚「嵩山府君」出現。。
LONG );
    set("exits", ([
        "down": "/d/songshan/fengchantai"
        ]));
    set("objects", ([
...
int do_put(string arg) {
    ...
    if(where == "xiang lu" ) {
        ...
        if(present("songshan fujun", this_object()) ) {
            tell_object(me, "嵩山府君已經在你面前了，你就沒有這個必要了吧。\n");
            return 1;
        }
