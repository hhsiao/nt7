...
void create() {
    set("short", "石室");
    set("long", @LONG
這是第一間石室。不少人走來走去，已經頗為擁擠。那些人有的
注目凝思，有的打坐練功，有的閉目喃喃自語，更有的正在大聲爭辯。
東面是塊打磨光滑的大石壁(wall)，石壁旁點燃著火把，把整間石室
照耀得白晝相仿。
LONG );
    set("exits", ([
    ...
    set("item_desc", ([
        "wall": @WALL
牆的正上方刻著「趙客縵胡纓」幾個大字。字的下方刻著一幅圖，圖
中是一個書生，他左手持扇，右手飛掌，神態甚是優雅瀟灑……旁有
一行註解雲：須從威猛剛硬處著手。另有無數小字，密密麻麻。
WALL
        ]));
    set("objects", ([
     ...
     * 緊接著鳩摩智使出「祝融懷焰」，雙手如抱圓球，內力運處，一股炙熱無形刀氣斬向血刀老
     * 祖的右耳！
