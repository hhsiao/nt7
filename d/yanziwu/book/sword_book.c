...
void create()
{
        set_name(HIM"慕容世家"HIG"短兵篇"HIC"劍章"NOR, ({"sword book","book"}));
        set_weight(500);
        set("unit", "冊");
        set("long","這是慕容世家的藏書中的"HIG"短兵篇"NOR"之"HIC"劍章"NOR"，包含了普天下所有門派的劍法精要。\n想修絕世武功，就好好看(kan)吧。\n");
        set("value", 1);
        set("material", "paper");
        setup();
}
