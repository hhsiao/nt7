...
void create() {
    set("short", "日月洞");
    set("long", @LONG
這裡是星宿派總舵所在地日月洞。洞內燈火通明，正中一把虎皮椅
上端坐著星宿派掌門人丁春秋。兩邊各站列著數十位星宿派弟子，不斷
有各派人士走進來獻(xian)上各種寶物。在一片歌功頌德之聲中，洋洋
盈耳，絲竹簫管也跟著吹奏。丁春秋每聽到得意之時，禁不住揮動手中
的羽扇，捋著白鬚，眯起了雙眼，薰薰然，飄飄然，有如飽醉醇酒。
    洞壁上裝飾著虎皮、鹿頭、雕羽，及一些字畫(zihua)。 洞兩側豎
立兵器架，上面排列的大多是各種棍棒。
LONG );
    set("exits", ([
