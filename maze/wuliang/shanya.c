...
int do_jump(string arg,object *obj)
{
        ...
        if( (query(QUESTDIR1+"start", me) && (random(query("kar", me))>8) )
         || (query(QUESTDIR1+"start", me) && query_temp(QUESTDIR1+"jianying", me) )
         || (random(query("kar", me))>20 )
